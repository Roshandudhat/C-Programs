// C program to implement the Roshan Dudhat Food and hotels.
// Ordering System
#include <stdio.h>
#include <string.h>
...
int main()
{
	while (1) {
		printf(""
			"\n\n=====WELCOME TO ROSHAN DUDHAT FOOD AND HOTELS ");
...
void hotel_initialize()
{
	...
	strcpy(m[3].hotel, "RD restorent");
	strcpy(m[3].first_food, "biriyani");
